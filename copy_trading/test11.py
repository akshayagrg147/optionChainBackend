                            ...
                            if self.order_placedPE or self.order_placedCE and not self.sell_order_placed and self.ltp_at_order is not None:
                                try:
                                    ...
                                    if self.locked_ltp is None:
                                        ...
                                        print('again ltp',self.locked_ltp)
                                    ...
                                    if pnl_percent < self.expected_profit_percent and current_ltp <= self.locked_ltp:
                                        ...
                                        print('again again againn ltp',self.locked_ltp)
